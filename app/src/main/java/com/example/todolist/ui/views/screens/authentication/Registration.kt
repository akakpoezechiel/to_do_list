                    ...
                    Button(
                        onClick = {
                            ...
                            if (!fullNameLengthValidation(fullName)) {
                                ...
                                isFullNameErrorText =
                                    context.getString(R.string.full_name_error_text)
                                isError = true
                            } else {
                            ...
                            if (!isError) {
                                ...
                                scope.launch {
                                    ...
                                    if (!isTermsAccepted) {
                                        isFullNameError = true
                                        isFullNameErrorText =
                                            context.getString(R.string.accept_terms_and_conditions)
                                        isLoading = false
                                    } else {
                                        if (authState.usersList.isNotEmpty()) {
                                            ...
                                            authViewModel.sendOTPCode(
                                                com.example.todolist.data.room.models.OTPCode(
                                                    email = email,
                                                    code = StringConstants.DefaultOTP.value
                                                )
                                            )
                        ...
                        Text(
                            text = if (isLoading) stringResource(id = R.string.loading) else stringResource(
